...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong> Pankaj Nebbulal Yadav </p>
    <p><strong>Email ID:</strong> yadavpankaj092785@gmail.com </p>
    <p><strong>College Name:</strong> VIVA Institute Of Technology </p>
    <p><strong>Branch/Specialization :</strong> MCA </p>
    <p><strong>College ID:</strong> 24036tb1yw </p>
</div>
...
<p><strong>Trainer Designation:</strong> Salesforce developer </p>
...
> During this internship, I learned the fundamentals of Salesforce development and administration, including objects, fields, flows, and Apex. I gained hands-on experience through a real-world Expense Management System project, which improved my problem-solving and practical skills. The trainer was very calm, supportive, and taught everything politely and professionally. He also guided me in job opportunities and certification preparation related to this course.


<h2 style="color:#333;"> Projects Completed </h2>
<div align="left" style="margin: 20px; font-size: 16px;">

<p><strong><a href="#project1">Project :</a></strong> Travelling and Expenses Management System </p>

</div>

<!-- Project 1 -->
<h3 id="project1">Project :Travelling and Expenses Management System<h3>
<p>
...
> LST (Life Skill Training) sessions played an important role in improving my overall personal and professional development. These sessions were conducted regularly (on alternate Sundays), where each session focused on different real-life skills.
...
During my internship period, I actively participated in community service activities, which helped me understand social responsibility and the importance of helping others.

### **Activities Involved**
<!-- add the location where you given -->
- **Blood Donation** – Donated blood at Sathiya Trust Blood Centre and contributed to supporting patients in need.
...
- Contributed to saving lives through blood donation and supporting healthcare needs. <!-- add the location where you given -->
